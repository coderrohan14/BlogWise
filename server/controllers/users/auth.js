...
const registerUser = async (req, res) => {
  ...
  if (user) {
    ...
    const mailOptions = {
      ...
      html: `<p>Please click the following link to verify your email address:</p><p><a href="https://blogbuzz.onrender.com/auth/verify/${verificationToken}">Verify Email</a></p>`,
    };
